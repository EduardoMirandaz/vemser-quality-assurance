...
Scenario Outline: Validar cadastro de usuario com telefone inválido
    ...
    Then devo verificar um texto de invalid phone <msgm>

    Examples:
        | sistema                                                                           | email             | genero | firstName  | lastName  | password  | companyName  | address      | city       | postCode | phone      | msgm     |
        | http://automationpractice.com/index.php?controller=authentication&back=my-account | teste123@joao.com | Mr.    | Eduardo    | Miranda   | senh@a1   | DBCom        | Joao Ramalho | Sao Carlos | 55236    | a          | invalid. |
